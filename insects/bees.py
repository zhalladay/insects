...
class Bees:
    ...
    def Left_Triangle_Tile(self, color, coord, turn):
        ...
        if turn == 'L':
            self.board.blit(self.L, (coord[0] + 18, coord[1] + 15))
        elif turn == 'R':
            self.board.blit(self.R, (coord[0] + 18, coord[1] + 15))
    ...
    def Right_Triangle_Tile(self, color, coord, turn):
        ...
        #mark if the tile is a left turning or right turning tile
        if turn == 'L':
            self.board.blit(self.L, (coord[0] + 10, coord[1] + 15))
        elif turn == 'R':
            self.board.blit(self.R, (coord[0] + 10, coord[1] + 15))
    ...
    def Draw_Bee_2(self, (col,row)):
        ...
        y =  12 -40 + 20 * row
        #draw the bee
        pygame.draw.polygon(self.board, (255,0,0), ((x-7,y+5), (x+5,y+2), (x-4,y-4)),)
        #store the bee's location
        self.bee = ((col, row), 2)
    ...
    def Draw_Bee_6(self, (col,row)):
        ...
        y = 25 + -40 + 20 * row
        #draw the bee
        pygame.draw.polygon(self.board, (255,0,0), ((x-5,y-8), (x-9,y+3), (x+3,y)),)
        #store the bee's location
        self.bee = ((col, row), 6)
